...
public class HtmlUtils {
    ...
    public static final String P_CHANGE_BUTTON = "<button class='ui inverted red button' onclick='toShowMap(";
    ...
    public static String publicSuggestToString(Integer suggestId, String username){
        return A_SUGGEST_URL + suggestId + A_NEXT + username + "的建议" + A_NEXT_URL;
    }

    public static String privateHtmlToString(Integer nodeId, Integer userId, String nodeName, String node){
        ...
        return  AP_PREFIX_URL + nodeId + URL + userId + AP_IS_UPDATE + A_NEXT + nodeName + A_NEXT_URL + LINE
                ...
                + P_DELETE_BUTTON + nodeId + B + node + P_DELETE_BUTTON_NEXT;
    }
