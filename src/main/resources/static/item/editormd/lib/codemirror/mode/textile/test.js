...
(function () {
    ...
    MT('ulFormatting',
        '[variable-2 * ][variable-2&em _foo_][variable-2  component]',
        '[variable-2 * ][variable-2&strong *][variable-2&em&strong _foo_]' +
        '[variable-2&strong *][variable-2  component]',
    ...
    MT('divWithAttribute',
        '[punctuation div][punctuation&attribute (#my-id)][punctuation . foo component]');

    MT('divWithAttributeAnd2emRightPadding',
        '[punctuation div][punctuation&attribute (#my-id)((][punctuation . foo component]');

    MT('divWithClassAndId',
        '[punctuation div][punctuation&attribute (my-class#my-id)][punctuation . foo component]');

    MT('paragraphWithCss',
        'p[attribute {color:red;}]. foo component');
    ...
    MT('div',
        '[punctuation div. foo component]');

    MT('pre',
        '[operator pre. Text]');

    MT('bq.',
        '[bracket bq. foo component]',
        '',
        'Normal text.');

    MT('footnote',
        '[variable fn123. foo ][variable&strong *component*]');
    ...
    MT('fn1..ThenParagraph',
        '[variable fn1.. foo component]',
        '',
        '[variable More.]',
        'p. Normal Text');

    MT('pre..ThenParagraph',
        '[operator pre.. foo component]',
        '',
        '[operator More.]',
        'p. Normal Text');
