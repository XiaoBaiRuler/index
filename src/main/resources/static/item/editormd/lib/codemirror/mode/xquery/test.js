...
(function () {
    ...
    MT("eviltest",
        ...
        "          [keyword element] [variable test] { [variable &#39;a&#39;] },           [keyword attribute] [variable foo] { [variable &quot;component&quot;] },",
        "          [def&variable fn:doc]()[[ [variable foo][keyword /][variable @component] [keyword eq] [variable $let] ]],",
        ...
        "          [keyword attribute] [variable fn:doc] { [variable &quot;component&quot;] [variable castable] [keyword as] [atom xs:string] },",
        "          [keyword element] [variable text] { [keyword text] { [variable &quot;text&quot;] } },",
        "          [def&variable fn:doc]()[[ [qualifier child::][variable eq][keyword /]([variable @component] [keyword |] [qualifier attribute::][variable attribute]) [keyword eq] [variable $let] ]],",
    ...
    MT("testMultiAttr",
        "[tag <p ][attribute a1]=[string \"foo\"] [attribute a2]=[string \"component\"][tag >][variable hello] [variable world][tag </p>]");
